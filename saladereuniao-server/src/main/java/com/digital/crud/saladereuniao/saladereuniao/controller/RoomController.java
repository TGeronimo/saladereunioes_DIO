...
import org.springframework.web.bind.annotation.CrossOrigin; // Para o front poder consumir a aplicação
...
@RestController
@CrossOrigin(origins = "http://localhost:4200") // Porta 4200 é a padrão do Angular
